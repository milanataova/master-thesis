#!/usr/bin/env python3
"""
Generate Scatterplots for Life Satisfaction Distributions
...
WVS_DATA_PATH = DATA_DIR / "WVS_Cross-National_Wave_7_csv_v6_0.csv"
SYNTHETIC_DATA_DIR = DATA_DIR / "synthetic_data" / "weighted"
OUTPUT_DIR = BASE_DIR / "Outputs" / "plots" / "scatterplots"
...
def main():
    ...
    print("="*80)
    print("Life Satisfaction Distribution Scatterplots")
    print("="*80)
    ...
    # Step 3: Calculate global y-limit
    print("\nStep 3: Calculating global y-limit...")
    all_max = []
    ...
    for country in TARGET_COUNTRIES:
        ...
        fig.suptitle(
            f"Life Satisfaction Distributions – {country}",
            fontsize=20,
            y=0.98,
        )
        ...
        out_path = OUTPUT_DIR / f"connected_scatter_{country}.png"
    ...
    print("\n" + "="*80)
    print("All scatterplots complete!")
